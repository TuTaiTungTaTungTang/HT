            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item mx-4 dropdown">
                        ...
                        if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin') {
                            ...
                            echo '<div class="nav-link active dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-expanded="false">MẶT HÀNG</div>
                    ...
                    <li class="nav-item mx-4">
                        ...
                        if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin') {
                            ...
                            if (isset($_SESSION['name']) && isset($_SESSION['id']) && isset($_SESSION['role']) && $_SESSION['role'] == 'user') {
                                ...
                                echo '<a class="nav-link active" aria-current="page" href="login.php">GIỎ HÀNG</a>';
                            }
                        }
                        ?>
                    </li>
                ...
                if ((isset($_SESSION['role']) && $_SESSION['role'] == 'user') || !isset($_SESSION['role'])) {
                    ...
                    <form action="search.php" method="GET" class="d-flex" role="search">
                        <input class="form-control me-2 search_input" name="keyword" type="search" required placeholder="Tìm kiếm quần áo..." aria-label="Search">
